...
";
if( $contador == 0 ){
if(!mysql_query("INSERT INTO pagos(codigo,fecha_pago,mes_pago,correlativo,cantidad,comentario,nit,usuario)
	VALUES('".$addcodigo."','$addfecha_pago','$addmes','$addcorrelativo','$addcantidad','$addcomentario','$addnit','".$usuario."')")){
	die ("
	ERROR: <br><br>
	<div class='container'>
