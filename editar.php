...
$sector = $_GET['sector'];
	...
	$consulta = mysql_query("SELECT * FROM clientes WHERE nombre = '$nombre' OR  sector LIKE '%$sector%' ORDER BY sector",$conexion);
...
while ($fila = mysql_fetch_array($consulta))
 {
	...
	&ultima_fac=".$fila['ultima_fac']."&ultimo_mes=".$fila['ultimo_mes']."&comentario=".$fila['comentario']."'>Actualizar</a></td>
	</tr>";
}

	echo "<table width=100%><tr><td>
	<form action='editarclientes.php'>
	<center>
